...
class MedicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medication" do
    assert_difference('Medication.count') do
      post medications_url, params: { medication: { dose: @medication.dose, frequency: @medication.frequency, name: @medication.name } }
    end
  ...
  test "should update medication" do
    patch medication_url(@medication), params: { medication: { dose: @medication.dose, frequency: @medication.frequency, name: @medication.name } }
